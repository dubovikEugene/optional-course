...
<html>
	...
	<body>
		...
		<div class="main">
			<h1 style="text-align: center">${courses_list_name}:</h1>
			<c:forEach var="courseRun" items="${requestScope.courses}">
				<details class="courses-list">
					<summary class="courseRun-name">${courseRun.courseName}
						<span style="float: right">${start_date}: ${courseRun.startDate} </span>
					</summary>
					<div class="summary-content">
							${courseRun.description}
